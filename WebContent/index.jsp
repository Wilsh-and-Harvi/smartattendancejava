                ...
                <div class="col-lg-9 col-md-12 login-card">
                    <div class="row">
                        <div class="col-md-5 detail-part">
                            ...
                            <p>Geo-fencing Mobile App to mark attendance automatically and link with RemSys. </p>
                            <%! demo f2=new demo(); %>
                          ...
                          <div class="row">
                              <div class="col-lg-10 col-md-12 mx-auto">
                                  <div class="logo-cover">
                                    ...
                                    <table>
                                    <tr><td>
                                   <img height="100" width="120" src="assets/images/SALOGO.png" alt=""></td><td align="top">
                                	     <h3 align="top">Welcome to <%= f2.getEmployeeid() %></h3></td></tr></table>
                                	      <%} else{%>
                                	      <% %>
                                       <img height="100" width="120" src="assets/images/SALOGO.png" alt="">
                                      <%}%>
                                   ...
                                   <form action = "MarkinServlet" method = "POST">
                                	   <button class="btn btn-primary button1">Login</button><br>
                                    ...
                                    <form action = "Markout" method = "POST">
                                     <button class="btn btn-primary button1">Logout</button><br>
